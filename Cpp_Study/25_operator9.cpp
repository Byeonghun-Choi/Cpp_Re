...
// 1. 생성자를 제공하지 않으면, 인자가 없는 기본생성자를 제공합니다.
// 2. 복사 생성자를 제공하지 않으면, 컴파일러는 복사생성자를 제공합니다. (얕은 복사)
// 3. 소멸자를 제공하지 않으면, 컴파일러는 소멸자를 제공합니다.
// 4. 사용자가 대입 연산자를 제공하지 않으면, 컴파일러는 대입 연산자를 제공합ㄴㅣ다.
